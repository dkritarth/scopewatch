...
- [Tested baseline handoff](baseline-2026-09-17.md) records the recovered prototypes, repeatable offline checks, and known limitations.
- [Hackathon checklist](hackathon.md) records submission requirements to revisit before entry.
